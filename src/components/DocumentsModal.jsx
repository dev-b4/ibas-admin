            ...
            {documents.map((doc, idx) => {
              ...
              return (
                <div key={idx} className="relative pl-8 md:pl-10 group">
                  ...
                  {/* Card */}
                  <a href={doc.fileUrl || '#'} target="_blank" rel="noreferrer" className="block p-5 bg-white border border-slate-200 rounded-2xl hover:border-emerald-400 hover:shadow-lg transition-all">
